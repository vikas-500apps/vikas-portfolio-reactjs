      ...
      <div className="2xl:max-w-[1320px] w-[95vw] mx-auto px-4 lg:pb-[90px]">
        <div className="text-center mb-[70px]">
          ...
          <div className="flex justify-center mt-6 space-x-8">
            <button
              className={` text-white font-[600] leading-[1] text-[12px] inline-flex justify-center items-center py-2 px-4 rounded-full hover:-translate-y-1 uppercase ${
              ...
              <>
                ...
                <div className="px-4 lg:w-[50%] w-full">
                  <div className="lg:max-w-[490px] lg:text-right pb-12 lg:mr-5 ml-5 max-w-full lg:ml-auto relative">
                    ...
                    <p className="mt-5 text-gray-500 font-normal leading-[1.75]">
                      This education equipped me with critical thinking skills,
                      problem-solving abilities, and a strong academic base. It
                      laid the groundwork for my future academic pursuits and
                      career aspirations in technology, emphasizing logical
